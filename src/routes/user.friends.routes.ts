...
friendRoute.route('/request/:status').post(authenticateToken,requestforcontrol);
friendRoute.route('/accepting/:status').post(authenticateToken,requestacceptedcontrol);
