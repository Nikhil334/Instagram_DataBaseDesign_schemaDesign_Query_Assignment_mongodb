...
const registerControl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, user_services_1.registerUsers)(req);
        if (!result) {
...
const loginControl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, user_services_1.loginUsers)(req, res);
        if (!result) {
            res.status(406).send({
...
const logoutcontrol = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, user_services_1.logoutservice)(req, res);
        if (!result) {
