...
friendRoute.route('/request/:status').post(user_authorization_1.authenticateToken, user_friends_controller_1.requestforcontrol);
friendRoute.route('/accepting/:status').post(user_authorization_1.authenticateToken, user_friends_controller_1.requestacceptedcontrol);
